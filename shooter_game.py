...
mixer.init()
back_music = os.path.join(image_folder, "fff.ogg")
mixer.music.load(back_music)
mixer.music.set_volume(15)
mixer.music.play()
f_sound = os.path.join(image_folder, "t.ogg")
...
back_img = os.path.join(image_folder, "fonik.jpg")
...
class Player(GameSprite):
    ...
    def fire(self):
        img_bullet = os.path.join(image_folder, "rr.png")
...
img_ship = os.path.join(image_folder, "korabl.png")
ship = Player(img_ship, 5, HEIGHT - 100, 80, 100, 10)
 
bullets = sprite.Group()
monsters = sprite.Group()
for i in range(1, 6):
    img_ufo = os.path.join(image_folder, "tarelka.png")
    monster = Enemy(img_ufo, randint(80, WIDTH - 80), -40, 80, 50, randint(1, 5))
    monsters.add(monster)
 
asteroids = sprite.Group()
for i in range(1, 3):
    img_asteroid = os.path.join(image_folder, "kamen.png")
